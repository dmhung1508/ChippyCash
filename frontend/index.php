   ...
   <div class="qa-container">
       <div class="qa-main">
           ...
           <div class="role-selector">
               <label for="chatRoleSelect">Chọn vai trò:</label>
               <select id="chatRoleSelect" class="role-select">
    ...
    <button id="sendQuestion" class="btn-primary">
       ...
       <div class="common-questions">
           <h3>Vai trò</h3>
           <p class="section-subtitle">Mỗi vai trò có phong cách trả lời khác nhau</p>
           
           <div class="role-descriptions">
               <div class="role-description">
                   <h4>Trợ lý thông minh</h4>
                   <p>Trả lời chuyên nghiệp, đưa ra lời khuyên tài chính hữu ích</p>
               </div>
               <div class="role-description">
                   <h4>Mama nóng tính</h4>
                   <p>Phản ứng như một người mẹ lo lắng về chi tiêu của bạn</p>
               </div>
               <div class="role-description">
                   <h4>Homie</h4>
                   <p>Trò chuyện như một người bạn thân, thân thiện và cởi mở</p>
               </div>
           </div>
       </div>
   </div>
...
<!-- Modal chỉnh sửa giao dịch từ chatbot -->
<div id="editTransactionsModal" class="modal">
  <div class="modal-content">
      <div class="modal-header">
          <h2>Chỉnh sửa giao dịch</h2>
          <button class="close-modal">&times;</button>
      ...
      <div class="modal-body">
          <div class="transaction-header">
              <p>Chỉnh sửa giao dịch của bạn trước khi lưu.</p>
          </div>
          ...
          <div class="transaction-actions">
              <button type="button" class="btn-secondary cancel-modal">Hủy</button>
              <button type="button" class="btn-primary" id="saveTransactionsBtn">
